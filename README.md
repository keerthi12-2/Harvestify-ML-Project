...
## DATA SOURCE 📊
- [Crop recommendation dataset ](https://www.kaggle.com/atharvaingle/crop-recommendation-dataset) (dataset)
- [Fertilizer suggestion dataset](https://github.com/Gladiator07/Harvestify/blob/master/Data-processed/fertilizer.csv) (dataset)
...
- Clone the complete project with `git clone https://github.com/keerthi12-2/Harvestify-ML-Project.git` or you can just download the code and unzip it
- It is highly recommended to clone the branch for running the project locally (the further steps apply only if you have the deploy branch cloned)
